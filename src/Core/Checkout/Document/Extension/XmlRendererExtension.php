 ...
 *
 * @title Rendering of the XML document
 *
 * @description This event allows manipulation of the input and output when rendering XML documents.
 *
 ...
 */
#[Package('after-sales')]
class XmlRendererExtension extends Extension
{
    public const NAME = 'xml-renderer';
